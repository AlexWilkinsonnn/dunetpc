...
class extrapolation::AddFDRecoTrim : public art::EDAnalyzer {
public:
  explicit AddFDRecoTrim(fhicl::ParameterSet const& p);

  // Plugins should not be copied or assigned.
  AddFDRecoTrim(AddFDRecoTrim const&) = delete;
  AddFDRecoTrim(AddFDRecoTrim&&) = delete;
  AddFDRecoTrim& operator=(AddFDRecoTrim const&) = delete;
  AddFDRecoTrim& operator=(AddFDRecoTrim&&) = delete;
...
extrapolation::AddFDRecoTrim::AddFDRecoTrim(fhicl::ParameterSet const& p)
...
void extrapolation::AddFDRecoTrim::analyze(art::Event const& e)
{
  // Get eventID
...
void extrapolation::AddFDRecoTrim::beginJob()
{
  fFile = new HighFive::File(fNDFDH5FileLoc, HighFive::File::ReadWrite);
}

void extrapolation::AddFDRecoTrim::endJob()
{
  // Write reco to hdf5
  fFile->createDataSet("fd_reco_trim", fReco);
}

recoFD extrapolation::AddFDRecoTrim::getReco(
...
DEFINE_ART_MODULE(extrapolation::AddFDRecoTrim)
